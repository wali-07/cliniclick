...
export const howAestheticClinicPricingWorksInTheUae = defineArticle({
  ...
  body: [
    ...
    },
    {
      type: "callout",
      variant: "context",
      title: "Why a very low price is worth questioning",
      text: "A price well below the market floor for a treatment is not automatically a bargain. It may reflect lower consumable quality, an unlicensed or less experienced practitioner, or a machine that is older, incorrectly maintained, or not the device being advertised. This is not about assuming bad intent - it is about understanding that costs are real and someone absorbs them.",
    },
    {
      type: "heading",
      level: 2,
      text: "How to compare two quotes like a professional",
    },
    {
      type: "paragraph",
      text: "Quotes are not comparable until you have standardised them. Use this approach every time.",
    },
    {
      type: "list",
      style: "number",
    ...
    },
    {
      type: "heading",
      level: 2,
      text: "How to read marketing claims on pricing",
    },
    {
      type: "paragraph",
      text: "Aesthetic marketing has its own vocabulary. Here is a translation guide for the phrases you will encounter most often.",
    },
    {
      type: "table",
      headers: ["What you see", "What to ask"],
      rows: [
        [
          '"Starting from AED X"',
          "What is the full price for my specific concern and the number of units or syringes typically needed?",
        ],
        [
          '"50% off this month"',
          "What is the standard price this is discounted from, and will the same practitioner and product be used?",
        ],
        [
          '"Free consultation"',
          "Is there any obligation to book, and will the consulting physician be the one who treats me?",
        ],
        [
          '"Premium / medical grade"',
          "Which specific product or machine does this refer to, and what regulatory approval does it carry?",
        ],
        [
          '"Natural results guaranteed"',
          "No outcome in aesthetic medicine can be guaranteed. What is the clinic's policy if you are not satisfied?",
        ],
        [
          '"Package of 6 sessions"',
          "Is each session the same treatment on the same machine, or does the package mix different protocols?",
        ],
      ],
    },
    {
      type: "checklist",
      title: "Questions to ask before confirming any booking",
      items: [
  ...
  faqs: [
    {
      question: "Why does the same treatment cost so much more in one clinic than another?",
      answer:
    ...
    {
      question: "Is it safe to buy a treatment package upfront?",
      answer:
    ...
    {
      question: "How do I know if the injectable product being used is legitimate?",
      answer:
    ...
    {
      question: "Should I always choose the most experienced - and most expensive - practitioner?",
      answer:
    ...
    {
      question: "What does a follow-up appointment actually involve, and does it matter?",
      answer:
    ...
    {
      question: "Are prices in UAE clinics regulated?",
      answer:
  ...
  sources: [
    {
      title: "Botulinum toxin - overview and clinical use",
      publisher: "American Academy of Dermatology",
      url: "https://www.aad.org/public/cosmetic/wrinkles/botulinum-toxin",
      type: "explainer",
    },
    {
      title: "Dermal fillers: uses, risks, and what to ask",
      publisher: "American Academy of Dermatology",
      url: "https://www.aad.org/public/cosmetic/fillers/dermal-fillers-risks",
      type: "explainer",
    },
    {
      title: "Licensing and regulation of health professionals",
      publisher: "Dubai Health Authority",
      url: "https://www.dha.gov.ae/en/HealthRegulation/Licensing",
      type: "regulator",
    },
    {
  ...
  relatedArticleSlugs: ["dermal-fillers-overview", "botox-overview"],
  published: true,
});
