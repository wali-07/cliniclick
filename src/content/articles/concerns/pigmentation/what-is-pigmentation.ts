...
export const whatIsPigmentation = defineArticle({
  ...
  dek: "Dark patches, sun spots, and the marks left behind by acne - what is actually happening in your skin, why it behaves so differently on darker skin tones, and how to think about your options.",
  eyebrow: "Concern overview",
  lastReviewed: "2026-05-16",
  metaTitle: "What is pigmentation? Melasma, sun spots, and what works",
  metaDescription:
    "Pigmentation explained from first principles: melasma, post-inflammatory marks, and sun spots, why darker skin is more prone, and how to evaluate your options in the UAE.",
  keywords: [
  ...
  body: [
    ...
    {
      type: "paragraph",
      text: "Skin colour comes from melanin, a pigment made by cells called melanocytes. Melanin is not a flaw - it is the skin's built-in sun protection, and it is the reason some skin tans rather than burns. Pigmentation problems happen when melanin is made in excess or ends up in the wrong place.[^1]",
    },
    {
      type: "list",
      style: "number",
    ...
    },
    {
      ...
      variant: "note",
      title: "Worth knowing",
      text: "How deep the pigment sits matters more than how dark it looks. Surface pigment can respond to creams and gentle treatments over months. Deeper pigment may barely move no matter what you spend. This is why a clinician's first job is often working out where the pigment actually is, not just reaching for a laser.",
    },

    {
      type: "heading",
      level: 2,
      text: "Why it is not just about scrubbing or bleaching",
    },
    {
      type: "paragraph",
    ...
    {
      type: "paragraph",
      text: "Different kinds of pigmentation have different causes and behave very differently in response to treatment. Working out which one you have is the first real step.",
    },
    {
      type: "table",
      headers: ["Type", "What it looks like", "What is driving it", "How it tends to behave"],
      rows: [
        [
          "Melasma",
          "Symmetrical brown or grey-brown patches, usually cheeks, forehead, upper lip",
          "Sun and visible light plus hormones (pregnancy, the pill) on a genetic tendency",
          "Chronic and relapsing - fades with care, returns with sun and hormones",
        ],
        [
          "Post-inflammatory hyperpigmentation (PIH)",
          "Flat dark marks exactly where a spot, ingrown hair, or injury was",
          "Inflammation stimulating extra melanin in the healing skin",
          "Often fades on its own over months, but slowly on darker skin",
        ],
        [
          "Sun spots (lentigines)",
          "Well-defined flat brown spots on the most sun-exposed areas",
          "Years of cumulative UV exposure",
          "Stable and persistent - does not fade without treatment",
        ],
      ],
    },
    {
      type: "callout",
      variant: "info",
      title: "Marks are not the same as scars",
      text: "A flat dark patch you can see but not feel is pigmentation, and it can fade. A dent or raised ridge you can feel is a textural scar, and it needs completely different treatment. People often spend on the wrong procedure because the two were never told apart. If you are not sure which you have, that question alone is worth a consultation.",
    },
    ...
    {
      type: "paragraph",
      text: "Pigmentation is not a single condition with a single trigger, so the typical picture depends on the type.[^2]",
    },
    {
      type: "list",
      style: "bullet",
    ...
    {
      type: "paragraph",
      text: "That changes the whole calculus. The biggest risk in treating pigmentation on darker skin is not that a treatment fails - it is that an aggressive treatment causes a fresh round of pigmentation worse than the original problem. Lasers, strong peels, and harsh devices all work by causing controlled injury, and on reactive skin that injury can itself trigger more melanin. The evidence is explicit that energy and peel treatments carry a real risk of worsening melasma or causing new post-inflammatory marks, especially when the settings or strength are not matched to the skin tone.[^1][^3]",
    },
    {
      type: "callout",
      variant: "context",
      title: "Why this changes how you should choose",
      text: "On darker skin the right question is not just \"will this fade my pigmentation\" but \"could this leave me darker than I started, and how often does that happen with this approach on skin like mine.\" Sun protection and gentle topicals carry almost no downside. Lasers and strong peels carry real upside and real downside, and the experience of whoever sets the device with your skin tone matters as much as the device itself.",
    },

    {
      type: "heading",
      level: 2,
      text: "Why sun protection is the foundation, not an add-on",
    },
    {
      type: "paragraph",
      text: "Almost every type of pigmentation is driven or maintained by light. Ultraviolet and visible light both push melanocytes to make more pigment, which is why melasma flares every summer and why marks that were fading suddenly darken again after a beach day. In a climate with strong year-round sun and a lot of reflected glare, daily broad-spectrum protection is not an optional extra - it is the single intervention that does the most, and it is the one thing that makes every other treatment actually hold.[^2][^3]",
    },
    {
      type: "list",
      style: "bullet",
    ...
    {
      type: "paragraph",
      text: "Some pigmentation - mild post-acne marks in particular - fades on its own with sun protection and patience. The signs it is worth getting a professional view are:",
    },
    {
      type: "checklist",
      items: [
    ...
    {
      type: "paragraph",
      text: "A DHA-licensed clinician can tell melasma from post-inflammatory marks from a sun spot, judge how deep the pigment is, and rule out anything that needs medical rather than cosmetic attention before any treatment plan is discussed.",
    },
    ...
    {
      type: "paragraph",
      text: "Real options fall into a clear order, and on darker skin that order matters: the gentlest, lowest-risk steps come first and do most of the work, with procedures layered on cautiously only if needed.[^1][^3]",
    },
    {
      type: "list",
      style: "bullet",
    ...
    {
      type: "paragraph",
      text: "If you are seeing a clinician about pigmentation, these questions help you compare answers across clinics and judge whether the plan is being matched to your skin rather than sold to you.",
    },
    {
      type: "checklist",
      items: [
  ...
  faqs: [
    ...
    {
      question: "Why is my pigmentation worse in the UAE than it was elsewhere?",
      answer:
    ...
    {
      question: "Can lasers fix pigmentation?",
      answer:
    ...
    {
      question: "How long does pigmentation take to fade?",
      answer:
    ...
    {
      question: "Are skin-lightening creams safe?",
      answer:
