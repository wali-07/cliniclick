...
export const BRAND_STYLE_SPEC = [
  ...
  `The ENTIRE background is ONE flat solid colour: the true brand purple`,
  `${BRAND_HEX.purple} or a soft lavender tint of that exact hue (or, less`,
  `often, deep navy ${BRAND_HEX.navy} or off-white ${BRAND_HEX.offWhite}).`,
  "It must be a clean violet-purple - NEVER magenta, fuchsia, hot-pink,",
  "blue-purple or any off-hue. Seamless, no gradient/vignette/second",
